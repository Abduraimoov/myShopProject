...
class DataBaseView: UIView {
    ...
    private func setupConstrains() {
        ...
        NSLayoutConstraint.activate([
            ...
            titleSurName.topAnchor.constraint(equalTo: topAnchor,
                                              constant: 100),
            
            titleName.centerXAnchor.constraint(equalTo: centerXAnchor),
            titleName.topAnchor.constraint(equalTo: titleSurName.bottomAnchor,
                                           constant: 10),
            
            titlePhoneNumber.centerXAnchor.constraint(equalTo: centerXAnchor),
            titlePhoneNumber.topAnchor.constraint(equalTo: titleName.bottomAnchor,
                                                  constant: 10),
            titleDate.centerXAnchor.constraint(equalTo: centerXAnchor),
            titleDate.topAnchor.constraint(equalTo: titlePhoneNumber.bottomAnchor,
                                           constant: 10)
        ])
    }
